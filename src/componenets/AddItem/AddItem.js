...
const AddItem = () => {
    ...
    const handleform = event => {
        ...
        const item = {name, country, category,image};
        console.log(item);
        ...
        <div className='mx-20 mt-8'>
            ...
            <div className='bg-white-200  mx-8 '>
                <div className='grid:justify-center my-4'>
                    <h2 className='text-center text-2xl font-semibold text-black my-4'>New Chocolates </h2>
                ...
                <form onSubmit={handleform}>
                    ...
                    <div className="form-control w-full ">
                        ...
                        <input type="text" name="country" placeholder="Enter Country Here" className="input input-bordered w-full" />
                    ...
                    <div className="form-control w-full">
                        ...
                        <input type="text" name="Category" placeholder="Write Category Here" className="input input-bordered w-full" />
